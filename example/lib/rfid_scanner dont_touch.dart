...
//               decoration: const InputDecoration(hintText: 'Gucu Girin'),
...
//                   powerLevel.text = value;
//                 }
//                 await RfidC72Plugin.setPowerLevel(value);
//                 setState(() {});
//               },
//             ),
//             ElevatedButton(
...
//                         TextEditingController adTxtCtrl =
//                             TextEditingController();
//                         TextEditingController epcTxtCtrl =
//                             TextEditingController();
//                         TextEditingController turTxtCtrl =
//                             TextEditingController();
//                         TextEditingController numberTxtCtrl =
//                             TextEditingController();
//                         epcTxtCtrl.text = tag.epc;
//                         // adTxtCtrl.text = '${item['ad']}';
//                         // turTxtCtrl.text = '${item['tur']}';
//                         // numberTxtCtrl.text = '${item['number']}';
//                         return AlertDialog(
...
//                                 keyboardType: TextInputType.multiline,
//                                 decoration:
//                                     const InputDecoration(hintText: 'EPC'),
//                                 enabled: false,
//                               ),
//                               TextField(
...
//                                 keyboardType: TextInputType.multiline,
//                                 decoration: const InputDecoration(
//                                     hintText: 'Tur giriniz'),
//                               ),
//                               TextField(
//                                 controller: numberTxtCtrl,
//                                 keyboardType: TextInputType.number,
//                                 decoration: const InputDecoration(
//                                     hintText: 'No giriniz'),
//                               ),
...
//                                     epc: epcTxtCtrl.text,
//                                     tur: turTxtCtrl.text,
//                                     number: int.parse(numberTxtCtrl.text));
