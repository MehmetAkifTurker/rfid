...
import 'package:rfid_c72_plugin_example/common/variables.dart';
                          ...
                          children: [
                            ...
                            Slider(
                              ...
                              onChanged: (newValue) async {
                                ...
                                powerLevelString =
                                    iPowerLevel.toInt().toString();
                                await RfidC72Plugin.setPowerLevel(
                                    powerLevelString);
                              },
                            ),
                  ...
                  ? Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          String elementName = '';
                          String elementID = '';
                          Map<String, Object?> elementFound = {};
                          final itemFoundInDB = alldbResult.any((element) {
                            if (element[epcColumn] == epc) {
                              elementName = element[adColumn].toString();
                              elementID = element[idColumn].toString();
                              elementFound = element;
                            }
                            return element[epcColumn] == epc;
                          });
                          ...
                          return Card(
                            color: itemFoundInDB ? Colors.green : Colors.white,
                            child: ListTile(
                              title: Text(epc),
                              subtitle: itemFoundInDB
                                  ? Column(
                                      crossAxisAlignment:
                              ...
                              onTap: () async {
                                ...
                                itemFoundInDB
                                    ? updateDBMethod(
                                        context, elementFound, elementID)
                                    : insertDBMethod(
                                        context, item, _selectedValue);
                              },
                              onLongPress: () async {
                                log(elementID);
                                itemFoundInDB
                                    ? await rawSQL.deleteFromDB(id: elementID)
                                    : null;
                                getAllDB();
                                getMasters();
                              },
